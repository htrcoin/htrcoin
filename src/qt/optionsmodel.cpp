...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeHighTemperatureAmount"))
        settings.setValue("nAnonymizeHighTemperatureAmount", 1000);
    nAnonymizeHighTemperatureAmount = settings.value("nAnonymizeHighTemperatureAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizeHighTemperatureAmount"))
        SoftSetArg("-anonymizetraveamount", settings.value("nAnonymizeHighTemperatureAmount").toString().toStdString());
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizeHighTemperatureAmount:
            return QVariant(nAnonymizeHighTemperatureAmount);
        case UseBlackTheme:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizeHighTemperatureAmount:
            nAnonymizeHighTemperatureAmount = value.toInt();
            settings.setValue("nAnonymizeHighTemperatureAmount", nAnonymizeHighTemperatureAmount);
            emit AnonymizeHighTemperatureAmountChanged(nAnonymizeHighTemperatureAmount);
            break;
        default:
            break;
        }
