...
void DarksendPage::toggleDarksend()
{
    ...
    else 
    {
        ...
        if (nAnonymizeHighTemperatureAmount == 0)
        {
...
void DarksendPage::updateDarksendProgress()
{
    ...
    QString strAnonymizeHighTemperatureAmount = BitcoinUnits::formatHtmlWithUnit(nDisplayUnit, nAnonymizeHighTemperatureAmount * COIN, false, BitcoinUnits::separatorAlways);
    ...
    if(currentBalance == 0)
    {
        ...
        //strAnonymizeHighTemperatureAmount = strAnonymizeHighTemperatureAmount.remove(strAnonymizeHighTemperatureAmount.indexOf("."), BitcoinUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = strAnonymizeHighTemperatureAmount + " / " + tr("%n Rounds", "", nDarksendRounds);
    ...
    if(nMaxToAnonymize > nAnonymizeHighTemperatureAmount*COIN) nMaxToAnonymize = nAnonymizeHighTemperatureAmount*COIN;

    if(nMaxToAnonymize == 0) return;

    if(nMaxToAnonymize >= nAnonymizeHighTemperatureAmount * COIN) {
        ui->labelAmountRounds->setToolTip(tr("Found enough compatible inputs to anonymize %1")
                                          .arg(strAnonymizeHighTemperatureAmount));
        //strAnonymizeHighTemperatureAmount = strAnonymizeHighTemperatureAmount.remove(strAnonymizeHighTemperatureAmount.indexOf("."), BitcoinUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = strAnonymizeHighTemperatureAmount + " / " + tr("%n Rounds", "", nDarksendRounds);
    } else {
    ...
    QString strDenomBalance = QString().setNum(denomBalance, 'g', 4) + " HTRC";
