...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("HighTemperatures");
    case mBTC: return QString("Milli-HighTemperatures (1 / 1,000)");
    case uBTC: return QString("Micro-HighTemperatures (1 / 1,000,000)");
    default: return QString("???");
    }
}
